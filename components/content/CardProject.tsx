      ...
      <div className='w-full flex flex-col justify-center items-start rounded gap-5'>
        ...
        <div className='w-full flex justify-between items-start flex-wrap flex-col lg:flex-row gap-5'>
          ...
          <div className='flex justify-center items-end gap-3'>
            ...
            <ExternalLink href={repo} customClassName='text-white inline-flex items-center rounded-lg bg-purple-500/40 p-2 hover:bg-purple-500 transition-all ease'>
            ...
            <ExternalLink href={link} customClassName='text-white inline-flex items-center rounded-lg bg-lime-400/40 p-2 hover:bg-lime-400 transition-all ease'>
